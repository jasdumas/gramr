...
2. Bundling the `write-good` program for stand-alone use in an R package was challenging. We relied on the vignettes for the V8 package, which was a huge help for getting starting. But we found that we needed to modify these instructions to correctly bundle the program. Trial and error eventually got us through.
